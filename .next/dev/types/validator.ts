...
// Validate ../../../app/api/distance-matrix/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/distance-matrix">> = Specific
  const handler = {} as typeof import("../../../app/api/distance-matrix/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
